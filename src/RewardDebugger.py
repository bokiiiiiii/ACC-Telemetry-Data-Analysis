...
class RewardDebugger:
    ...
    def log_episode_stats(
        self, episode_num, total_reward, episode_length, avg_speed, max_damage
    ):
        """
    ...
    def plot_reward_trends(self, output_file=None):
        ...
        axes[0, 1].plot(
            self.episode_stats["episode"], self.episode_stats["length"], marker="."
        )
        ...
        # Average Speed trend
        axes[1, 0].plot(
            self.episode_stats["episode"], self.episode_stats["avg_speed"], marker="."
        )
        ...
        # Damage trend
        axes[1, 1].plot(
            self.episode_stats["episode"], self.episode_stats["max_damage"], marker="."
        )
...
class EpisodeMetricsTracker:
    ...
    def get_summary(self):
        ...
        return {
            ...
            "avg_steering_rate": (
                np.mean(self.steering_rates) if self.steering_rates else 0
            ),
